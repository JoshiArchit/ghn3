...
from ghn3 import GHN3, log, Trainer, DeepNets1MDDP, setup_ddp, clean_ddp, custom_imageloader
...
def main():
    ...
    parser.add_argument('--n_shots', type=int, default=None,
                        help='precent of training images per class')
    ...
    train_queue, _, num_classes = custom_imageloader.image_loader(args.dataset,
                                                                  args.data_dir,
                                                                  im_size=args.imsize,
                                                                  test=False,
